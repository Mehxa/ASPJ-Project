...
CREATE TABLE `comment_votes` (
  ...
  CONSTRAINT `fk_comment_votes_UserID` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`)
...
-- Dump completed on 2020-06-24 17:31:23
